...
constexpr psa_storage_uid_t kPsUniqueIdUid{ CONFIG_DOOR_LOCK_INTERNAL_ZMS_ROLLBACK_PROTECTION_UNIQUE_ID_UID };

constexpr auto kSettingsPrefix{ CONFIG_DOOR_LOCK_INTERNAL_ZMS_ROLLBACK_PROTECTION_SETTINGS_PREFIX };
